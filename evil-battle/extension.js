				...
				game.import("character", function () {
					var against7devil = {
						...
						character: {
							...
							"fusion_puyuan": ["male", "shu", 10, ["shenhu", "olshengong", "olqisi", "pytianjiang", "pyzhuren", "bianshui"], ["zhu", "boss", "bossallowed"]],
						},
						characterSort: {
							against7devil: {
						...
						skill: {
							...
							bianshui: {
								...
								content: function () {
									...
									'step 1'
									game.log(event.control);
									player.storage.bianshui_effect = [event.control, name];
									if (Math.random() < 0.5) {
										target.storage.bianshui_ai = name;
										target.addTempSkill('bianshui_ai', 'phaseUseAfter');
									}

									'step 2'
									player.storage.bianshui_effect[2] = (result.index == 0);
								},
								ai: { expose: 0.35 },
								subSkill: {
									ai: {
										...
										ai: {
											effect: {
												player: function (card, player, target) {
													if (card.name == player.storage.bianshui_ai) return 'zeroplayertarget';
												},
											},
										},
									},
									...
									effect: {
										...
										onremove: true,
										filter: function (event, player) {
											var info = player.storage.bianshui_effect;
										...
										content: function () {
											...
											if (player.storage.success === player.storage.bianshui_effect[0]) {
												player.draw();
